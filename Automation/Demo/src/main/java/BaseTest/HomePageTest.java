...
public class HomePageTest extends BaseSetup {
    ...
    public void clickHoverCatogories() {
        ...
        sleep(10);
        HomePageTest.nav_GraphicsDesign();
...
//        WebElement result = HomePageTest.catagoriesMenu("Graphics & Design");
    ...
    @Test
    public void hover_Digitalmarketing(){
        this.gotoHomePage();
        sleep( 15);
        ActionKeyword actionKeyword= new ActionKeyword(driver);
        WebElement element  = driver.findElement(By.xpath(Locator_CMS.trustBy));
        actionKeyword.scrollToElement(element);
        sleep(10);
        HomePageTest.nav_DigitalMarketing();
        LogUtils.info("Click key WordPress of Popular Search Passed");
    }
    @Test
    public void hover_Writing(){
        this.gotoHomePage();
        sleep( 15);
        ActionKeyword actionKeyword= new ActionKeyword(driver);
        WebElement element  = driver.findElement(By.xpath(Locator_CMS.trustBy));
        actionKeyword.scrollToElement(element);
        sleep(10);
        HomePageTest.nav_WritingTranslation();
        LogUtils.info("Click key WordPress of Popular Search Passed");
    }
    @Test
    public void hover_video(){
        this.gotoHomePage();
        sleep( 15);
        ActionKeyword actionKeyword= new ActionKeyword(driver);
        WebElement element  = driver.findElement(By.xpath(Locator_CMS.trustBy));
        actionKeyword.scrollToElement(element);
        sleep(10);
        HomePageTest.nav_Video_Animation();
        LogUtils.info("Click key WordPress of Popular Search Passed");
    }
    @Test
    public void hover_music(){
        this.gotoHomePage();
        sleep( 15);
        ActionKeyword actionKeyword= new ActionKeyword(driver);
        WebElement element  = driver.findElement(By.xpath(Locator_CMS.trustBy));
    ...
    public void hover_testing(){
        ...
        actionKeyword.scrollToElement(element);
        sleep(10);
        HomePageTest.nav_Testing();
        LogUtils.info("Click key WordPress of Popular Search Passed");
        element.click();
    }
    //Catogories Menu
    @Test( )
    public void clickGraphics_Design() {
        this.gotoHomePage();
        sleep( 15);
        ActionKeyword actionKeyword= new ActionKeyword(driver);
        WebElement element  = driver.findElement(By.xpath(Locator_CMS.trustBy));
        ...
        sleep(10);
        WebElement result= HomePageTest.clickElement(Locator_CMS.categoriesMenu,"Graphics & Design");
        actionKeyword.clickElement(result);
        actionKeyword.scrollToTop();
        LogUtils.info("Click key WordPress of Popular Search Passed");
    }
}