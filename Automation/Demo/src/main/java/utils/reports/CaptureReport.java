...
public class CaptureReport extends ScreenRecorder{
    ...
    //Hàm xây dựng
    public CaptureReport(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat, Format screenFormat, Format mouseFormat, Format audioFormat, File movieFolder, String name) throws IOException, AWTException {
    ...
    public static void captureScreenshot(WebDriver driver, String screenshotName) {
        try {
            ...
            System.out.println("Screenshot taken current URL: " + driver.getCurrentUrl());
        } catch (Exception e) {
